...
import com.job.portal.web.application.entity.*;
...
import com.job.portal.web.application.service.JobSeekerApplyService;
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                for (JobPostActivity jobActivity : jobPost) {
                    ...
                    for (JobSeekerApply jobSeekerApply : jobSeekerApplyList) {
                        if (Objects.equals(jobActivity.getId(), jobSeekerApply.getJob().getId())) {
                    ...
                    for (JobSeekerSave jobSeekerSave : jobSeekerSaveList) {
                        if (Objects.equals(jobActivity.getId(), jobSeekerSave.getJob().getId())) {
